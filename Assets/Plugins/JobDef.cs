...
//	}
    ...
    public JobDef()
    {
        ...
        var nodes = parser.Parse(File.ReadAllText("JobDefs.xml"));

        var jobCount = nodes.GetNodeList("job").Count;
        int propertyCount;
        int id;
        ...
        for (var i = 0; i < jobCount; i++)
        {
            ...
            for (var i2 = 0; i2 < propertyCount; i2++)
                ...
                if (nodes.GetValue("job>" + i + ">property>" + i2 + ">@type") == null)
                    ...
                    table[id].Add(nodes.GetValue("job>" + i + ">property>" + i2 + ">@name"),
                        nodes.GetValue("job>" + i + ">property" + i2 + "_text"));
        }
    }
