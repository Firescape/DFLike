...
public class XMLParser
{
    ...
    public XMLNode Parse(string content)
    {
        ...
        var inElement = false;
        var collectNodeName = false;
        var collectAttributeName = false;
        var collectAttributeValue = false;
        var quoted = false;
        var attName = "";
        var attValue = "";
        var nodeName = "";
                ...
                if (collectNodeName)
                {
                    ...
                    if (!collectNodeName && nodeName.Length > 0)
                        ...
                        else
                        {
                            ...
                            var a = (XMLNodeList) currentNode[nodeName];
                            a.Push(newNode);
