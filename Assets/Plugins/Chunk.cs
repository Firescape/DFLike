...
{
	Mesh2[] meshList = new Mesh2[G.chunkSize.x * G.chunkSize.y * G.chunkSize.z];
	bool[] maskList = new bool[G.chunkSize.x * G.chunkSize.y * G.chunkSize.z];
	...
	public void rebuild()
	{
		MeshSegment[] segments = new MeshSegment[16384];
		int combineCount = 0;
		...
		Mesh newMesh = Face.combineMeshes(segments);
